...
public abstract class Downloader {
     ...
     * <br>
     * This method calls {@link #get(String, Map, Localization)}
     * with the default preferred localization. It should only be used when the resource
     * that will be fetched won't be affected by the localization.
     *
     ...
     * @return the result of the GET request
     */
    public Response post(final String url, @Nullable final Map<String, List<String>> headers,
