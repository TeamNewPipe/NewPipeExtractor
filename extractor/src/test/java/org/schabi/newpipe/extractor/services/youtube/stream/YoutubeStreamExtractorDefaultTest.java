...
public class YoutubeStreamExtractorDefaultTest {
     ...
     * Test for {@link StreamExtractor}
     */
    public static class AdeleHello extends YoutubeStreamExtractorBaseTest {
        @BeforeClass
    ...
    public static class DescriptionTestPewdiepie extends YoutubeStreamExtractorBaseTest {
        @BeforeClass
        public static void setUp() throws Exception {
            NewPipe.init(Downloader.getInstance(), new Localization("GB", "en"));
            extractor = (YoutubeStreamExtractor) YouTube
    ...
    public static class DescriptionTestUnboxing extends YoutubeStreamExtractorBaseTest {
        @BeforeClass
        public static void setUp() throws Exception {
            NewPipe.init(Downloader.getInstance(), new Localization("GB", "en"));
            extractor = (YoutubeStreamExtractor) YouTube
