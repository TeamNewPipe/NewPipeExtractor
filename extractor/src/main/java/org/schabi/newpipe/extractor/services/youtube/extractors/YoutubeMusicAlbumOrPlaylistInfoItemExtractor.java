...
public class YoutubeMusicAlbumOrPlaylistInfoItemExtractor implements PlaylistInfoItemExtractor {
    ...
    public String getName() throws ParsingException {
        final var textObject = albumOrPlaylistInfoItem.getArray("flexColumns")
                .getObject(0)
    ...
    public String getUploaderUrl() throws ParsingException {
        ...
        return getMusicUploaderUrlFromMenu(albumOrPlaylistInfoItem)
                // then try obtaining it from the uploader description element
                .or(() -> getUrlFromNavigationEndpoint(descriptionElementUploader
