...
import org.schabi.newpipe.extractor.services.youtube.youtube.extractors.YoutubeMusicSearchExtractor;
import org.schabi.newpipe.extractor.services.youtube.youtube.extractors.YoutubePlaylistExtractor;
import org.schabi.newpipe.extractor.services.youtube.youtube.extractors.YoutubeSearchExtractor;
import org.schabi.newpipe.extractor.services.youtube.youtube.extractors.YoutubeStreamExtractor;
import org.schabi.newpipe.extractor.services.youtube.youtube.extractors.YoutubeSuggestionExtractor;
...
public class YoutubeDirectService extends YoutubeLikeStreamingService {
    ...
    public PlaylistExtractor getPlaylistExtractor(final ListLinkHandler linkHandler) {
        if (YoutubePlaylistHelper.isYoutubeMixId(linkHandler.getId())) {
    ...
    public static final List<Localization> SUPPORTED_LANGUAGES = Localization.listFrom(
            "en-GB"
    ...
    public static final List<ContentCountry> SUPPORTED_COUNTRIES = ContentCountry.listFrom(
