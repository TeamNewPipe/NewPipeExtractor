...
public abstract class Stream implements Serializable {
     ...
     */
    public Stream(final String id, final String content, final boolean isUrl, final MediaFormat format, final DeliveryMethod deliveryMethod) {
        this.id = id;
     ...
     */
    public static boolean containSimilarStream(final Stream stream, final List<? extends Stream> streamList) {
    ...
    /**
     * Whether the content is an URL or the actual content of e.g. a DASH manifest
     *
     * @return true if the content is an URL
     */
