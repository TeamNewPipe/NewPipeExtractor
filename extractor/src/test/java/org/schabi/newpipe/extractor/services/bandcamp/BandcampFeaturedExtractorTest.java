 ...
 */
public class BandcampFeaturedExtractorTest extends DefaultSimpleExtractorTest<BandcampFeaturedExtractor>
    implements BaseListExtractorTest {

    @Override
    protected BandcampFeaturedExtractor createExtractor() throws Exception {
        return (BandcampFeaturedExtractor) Bandcamp.getKioskList().getDefaultKioskExtractor();
    }
