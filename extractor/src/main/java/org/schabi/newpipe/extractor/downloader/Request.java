...
public class Request {
    ...
    public Request(final String httpMethod, final String url,
                   Map<String, List<String>> headers, @Nullable final byte[] dataToSend,
    ...
    public static final class Builder {
        ...
        /**
         * A list of headers that will be used in the request.<br>
         * Any default headers that the implementation may have,
         * <b>should</b> be overridden by these.
         */
        public Builder headers(@Nullable final Map<String, List<String>> headers) {
            if (headers == null) {
                this.headers.clear();
                return this;
            }
         ...
         * (for example, {@code Content-Length} in a post request).
         */
        public Builder dataToSend(final byte[] dataToSend) {
            this.dataToSend = dataToSend;
            return this;
        }
         ...
         * method to do this easily: {@link Request#headersFromLocalization(Localization)}).
         */
        public Builder localization(final Localization localization) {
            this.localization = localization;
            return this;
        }
         ...
         */
        public Builder automaticLocalizationHeader(final boolean automaticLocalizationHeader) {
        ...
        public Builder post(final String url, @Nullable final byte[] dataToSend) {
    ...
    public static Map<String, List<String>> headersFromLocalization(
        ...
        if (!localization.getCountryCode().isEmpty()) {
            headers.put("Accept-Language", Collections.singletonList(localization
                    .getLocalizationCode() + ", " + localization.getLanguageCode() + ";q=0.9"));
        } else {
