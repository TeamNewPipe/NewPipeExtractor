package org.schabi.newpipe.extractor.services.youtube.shared.extractors;
 ...
 */
public class YoutubeTakeoutSubscriptionExtractor extends SubscriptionExtractor {
    private static final String BASE_CHANNEL_URL = "https://www.youtube.com/channel/";

    public YoutubeTakeoutSubscriptionExtractor(final YoutubeLikeStreamingService youtubeService) {
    ...
    public List<SubscriptionItem> fromCsvInputStream(@Nonnull final InputStream contentInputStream)
        ...
        try (final BufferedReader br = new BufferedReader(new InputStreamReader(contentInputStream))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (currentLine > 5 && subscriptionItems.isEmpty()) {
                    break;
                }
                ...
                final String channelUrl = line
                        .substring(i1 + 1, i2)
                        .replace(Utils.HTTP, Utils.HTTPS);
