...
class BSNetworkStreamExtractor(service: StreamingService?, linkHandler: LinkHandler?) : StreamExtractor(service, linkHandler) {
    ...
    override fun getOriginalUrl(): String {
        return data.getObject("network")?.getString("key")?.let {
