 ...
 */
public class InvidiousPlaylistExtractorTest {
    ...
    public static class NotAvailable {
        ...
        public void nonExistentFetch() throws Exception {
            final PlaylistExtractor extractor =
                    Invidious.getPlaylistExtractor("https://www.youtube.com/playlist?list=PL11111111111111111111111111111111");
            extractor.fetchPage();
        }
        ...
        public void invalidId() throws Exception {
            final PlaylistExtractor extractor =
                    Invidious.getPlaylistExtractor("https://www.youtube.com/playlist?list=INVALID_ID");
            extractor.fetchPage();
        }
    }

    public static class TimelessPopHits implements BasePlaylistExtractorTest {
        private static InvidiousPlaylistExtractor extractor;

        @BeforeClass
        public static void setUp() throws Exception {
            NewPipe.init(DownloaderTestImpl.getInstance());
            extractor = (InvidiousPlaylistExtractor) Invidious
...
//            assertTrue(uploaderAvatarUrl, uploaderAvatarUrl.contains("yt"));
    ...
    public static class HugePlaylist implements BasePlaylistExtractorTest {
        ...
        public void testGetPageInNewExtractor() throws Exception {
            final PlaylistExtractor newExtractor = Invidious.getPlaylistExtractor(extractor.getUrl());
