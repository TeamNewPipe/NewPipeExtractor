...
public class SoundcloudCommentsLinkHandlerFactory extends ListLinkHandlerFactory {
    ...
    public static SoundcloudCommentsLinkHandlerFactory getInstance(StreamingService service) {
        SoundcloudCommentsLinkHandlerFactory.service = service;
        return instance;
    }
    ...
    public String getUrl(String id, List<String> contentFilter, String sortFilter) throws ParsingException {
        try {
            return "https://api-v2.soundcloud.com/tracks/" + id + "/comments" + "?client_id=" + clientId(service) +
    ...
    public String getId(String url) throws ParsingException {
        ...
        return SoundcloudStreamLinkHandlerFactory.getInstance(service).getId(url);
    }
