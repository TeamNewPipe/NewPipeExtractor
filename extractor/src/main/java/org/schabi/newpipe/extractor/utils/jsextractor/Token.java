...
public class Token {
    ...
    public static String keywordToName(int token) {
        switch (token) {
            case org.mozilla.javascript.Token.BREAK:
                return "break";
            case org.mozilla.javascript.Token.CASE:
                return "case";
            case org.mozilla.javascript.Token.CONTINUE:
                return "continue";
            case org.mozilla.javascript.Token.DEFAULT:
                return "default";
            case org.mozilla.javascript.Token.DELPROP:
                return "delete";
            case org.mozilla.javascript.Token.DO:
                return "do";
            case org.mozilla.javascript.Token.ELSE:
                return "else";
            case org.mozilla.javascript.Token.FALSE:
                return "false";
            case org.mozilla.javascript.Token.FOR:
                return "for";
            case org.mozilla.javascript.Token.FUNCTION:
                return "function";
            case org.mozilla.javascript.Token.IF:
                return "if";
            case org.mozilla.javascript.Token.IN:
                return "in";
            case org.mozilla.javascript.Token.LET:
                return "let";
            case org.mozilla.javascript.Token.NEW:
                return "new";
            case org.mozilla.javascript.Token.NULL:
                return "null";
            case org.mozilla.javascript.Token.RETURN:
                return "return";
            case org.mozilla.javascript.Token.SWITCH:
                return "switch";
            case org.mozilla.javascript.Token.THIS:
                return "this";
            case org.mozilla.javascript.Token.TRUE:
                return "true";
            case org.mozilla.javascript.Token.TYPEOF:
                return "typeof";
            case org.mozilla.javascript.Token.VAR:
                return "var";
            case org.mozilla.javascript.Token.VOID:
                return "void";
            case org.mozilla.javascript.Token.WHILE:
                return "while";
            case org.mozilla.javascript.Token.WITH:
                return "with";
            case org.mozilla.javascript.Token.YIELD:
                return "yield";
            case org.mozilla.javascript.Token.CATCH:
                return "catch";
            case org.mozilla.javascript.Token.CONST:
                return "const";
            case org.mozilla.javascript.Token.DEBUGGER:
                return "debugger";
            case org.mozilla.javascript.Token.FINALLY:
                return "finally";
            case org.mozilla.javascript.Token.INSTANCEOF:
                return "instanceof";
            case org.mozilla.javascript.Token.THROW:
                return "throw";
            case org.mozilla.javascript.Token.TRY:
                return "try";
            default:
                return null;
        }
